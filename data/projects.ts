...
const projects: Project[] = [
  {
    ...
    tags: ['Python', 'Django', 'Tensorflow', 'Keras', 'TailwindCSS'],
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    title: 'MyGadgets',
    desc: 'MyGadgets" is a user-friendly online store with a responsive design, secure login, and essential shopping features.',
    img: '/images/myGadgets.png',
    link: 'https://fe-may23-syncwave.github.io/client/',
    github: 'https://github.com/orgs/fe-may23-syncwave/repositories',
    tags: ['React', 'NodeJS', 'TypeScript', 'PostgreSQL', 'Sequelize-ORM'],
  },
  {
    id: 5,
